...
const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$y);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Bookmark = createLucideIcon("bookmark", __iconNode$x);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Frown = createLucideIcon("frown", __iconNode$l);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MOCK_JOBS = [
  {
    ...
    description: "Join Stripe's world-class design team and shape the future of financial infrastructure.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Build beautiful, accessible user interfaces for millions of travelers worldwide.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Lead design strategy for Notion's collaborative workspace platform.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Shape Linear's technical direction and build tools developers love.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Define and execute the product vision for Figma's collaboration features.",
    responsibilities: [
      "Own product roadmap",
...
const TABS$1 = ["applied", "interviewing", "rejected"];
const COUNTS = {
  applied: MOCK_APPLICATIONS.filter((a) => a.status === "applied").length,
  interviewing: MOCK_APPLICATIONS.filter((a) => a.status === "interviewing").length,
  rejected: MOCK_APPLICATIONS.filter((a) => a.status === "rejected").length
};
function ApplicationsScreen() {
  const [filter, setFilter] = reactExports.useState("applied");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-14 px-5 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "My Applications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-sm mt-1", children: [
        MOCK_APPLICATIONS.length,
        " total applications"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: TABS$1.map((tab) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex flex-col items-center p-3 rounded-2xl transition-all ${isActive ? "text-white shadow-lg" : "bg-gray-50 text-gray-700"}`,
          style: isActive ? {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              cfg.Icon,
              {
                className: `w-5 h-5 mb-1 ${isActive ? "text-white" : "text-gray-500"}`
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold", children: COUNTS[tab] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-[10px] font-semibold mt-0.5 ${isActive ? "text-white/80" : "text-gray-500"}`,
                children: cfg.label
              }
            )
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-5 pb-4", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center h-64",
        "data-ocid": "applications.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Inbox, { className: "w-10 h-10 text-gray-300 mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "No applications in this category" })
        ]
      }
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: app.companyInitial
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm truncate", children: app.title }),
...
function formatSalary$1(min, max) {
  return `$${Math.round(min / 1e3)}K – $${Math.round(max / 1e3)}K/year`;
}
function CompanyLogoImg$1({
  logo,
  color,
  initial,
  size = 64
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-1 rounded-full bg-gray-200 mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900", children: job.company }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: job.employmentType })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto pb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-gray-50 border border-gray-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-gray-800 mb-1 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-4 h-4 text-gray-500" }),
                job.company
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mb-2", children: "Tech-forward company building the future" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full", children: "500–2000 employees" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 bg-purple-50 text-purple-600 text-xs font-semibold rounded-full", children: "Technology" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900 flex-1 mr-4", children: job.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-3 py-1 bg-gray-100 text-gray-600 text-xs font-semibold rounded-full flex items-center gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-3 py-1 bg-gray-100 text-gray-600 text-xs font-semibold rounded-full flex items-center gap-1", children: [
                  ...
                  " ",
                  formatSalary$1(job.salaryMin, job.salaryMax)
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-blue-700 uppercase tracking-wide mb-2", children: "Why You Match" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-700", children: [
                      job.aiReason,
                      ". Your background closely aligns with what",
                      " ",
                      job.company,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-900 mb-2", children: "About the Role" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: job.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-900 mb-2", children: "Responsibilities" }),
                job.responsibilities.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-500 mt-0.5", children: "•" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: r })
                ] }, r))
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-900 mb-2", children: "Skills" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: job.skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-900 mb-2", children: "Perks & Benefits" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: job.perks.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-t border-gray-100 flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setSaved(!saved),
                className: `flex-1 py-3.5 rounded-2xl font-semibold text-sm border transition-all flex items-center justify-center gap-1.5 ${saved ? "bg-blue-50 border-blue-200 text-blue-600" : "bg-white border-gray-200 text-gray-700"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: applied ? "#10b981" : "linear-gradient(135deg, #2563EB, #7C3AED)"
                },
                children: applied ? "Applied!" : "Apply Now"
              }
            )
          ] })
        ]
...
function formatSalary(min, max) {
  return `$${Math.round(min / 1e3)}K–$${Math.round(max / 1e3)}K`;
}
...
function JobCard({
  ...
  const transform = flying ? flyTransform : isTop ? `translateX(${dragX}px) translateY(${translateY}px) rotate(${rotate}deg)` : `translateY(${translateY}px) scale(${scale})`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "absolute inset-x-4 rounded-3xl bg-white overflow-hidden",
      role: isTop ? "button" : void 0,
      tabIndex: isTop ? 0 : void 0,
      style: {
        top: 0,
        bottom: 0,
        transform,
        transition: flying || !isTop ? "all 0.4s cubic-bezier(0.25,0.46,0.45,0.94)" : "none",
        boxShadow: "0 8px 40px rgba(0,0,0,0.12)",
        zIndex: 10 - offset,
        userSelect: "none",
        touchAction: "none"
      },
      onTouchStart: isTop ? onTouchStart : void 0,
      onTouchMove: isTop ? onTouchMove : void 0,
      onTouchEnd: isTop ? onTouchEnd : void 0,
      onClick: isTop ? onTap : void 0,
      onKeyDown: isTop ? (e) => e.key === "Enter" && onTap() : void 0,
      children: [
        isTop && swipeAction === "apply" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 left-6 z-20 px-4 py-2 rounded-xl border-2 border-green-500 rotate-[-12deg]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-500 font-black text-xl flex items-center gap-1", children: [
          "APPLY ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, className: "inline" })
        ] }) }),
        isTop && swipeAction === "save" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 right-6 z-20 px-4 py-2 rounded-xl border-2 border-yellow-500 rotate-[12deg]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-yellow-500 font-black text-xl flex items-center gap-1", children: [
          "SAVE ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { size: 16, className: "inline" })
        ] }) }),
        isTop && swipeAction === "super" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 left-1/2 -translate-x-1/2 z-20 px-4 py-2 rounded-xl border-2 border-blue-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-blue-500 font-black text-xl flex items-center gap-1", children: [
          "SUPER ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 18, className: "inline" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { height: 160 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: job.companyBanner,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchBadge, { score: job.matchScore }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-6 left-5 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            CompanyLogoImg,
            {
              logo: job.companyLogo,
              color: job.companyColor,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-5 pt-9 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 leading-tight mb-0.5", children: job.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 font-medium text-sm", children: job.company }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400 text-xs flex items-center gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, className: "inline mr-0.5" }),
                job.location
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400 text-xs flex items-center gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 12, className: "inline mr-0.5" }),
                formatSalary(job.salaryMin, job.salaryMax)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full", children: job.employmentType })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-1.5 line-clamp-2 leading-relaxed", children: job.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-3", children: job.skills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `px-2.5 py-1 rounded-full text-xs font-semibold ${SKILL_COLORS$1[i % SKILL_COLORS$1.length]}`,
              children: s
            },
            s
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14, className: "text-purple-400 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 italic", children: job.aiReason })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Tap for details \\u2192" }) })
        ] })
      ]
    }
  );
...
function DiscoverScreen() {
  const [jobs, setJobs] = reactExports.useState([...MOCK_JOBS]);
  const [flying, setFlying] = reactExports.useState(null);
  const [dragX, setDragX] = reactExports.useState(0);
  const [dragY, setDragY] = reactExports.useState(0);
  const [swipeAction, setSwipeAction] = reactExports.useState(null);
  ...
  function triggerSwipe(dir, _action) {
    setFlying(dir);
    setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 pt-14 pb-3 bg-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-900 text-lg", children: "CareerUp" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative mx-0 my-2", children: jobs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 56, className: "text-gray-300 mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-900 mb-2", children: "You're all caught up!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-center text-sm mb-6", children: "No more matches for today. Check back tomorrow or update your preferences." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    ] }) : jobs.slice(0, 3).map((job, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      JobCard,
      {
        job,
        isTop: i === 0,
    ...
    jobs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-5 pb-4 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { size: 22, className: "text-yellow-500" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: { background: "linear-gradient(135deg, #2563EB, #7C3AED)" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 26, className: "text-white" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "w-14 h-14 rounded-full bg-white shadow-lg flex items-center justify-center border border-gray-100 active:scale-90 transition-transform",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 22, className: "text-green-500" })
        }
      )
    ] }),
    ...
    showNotifications && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 pt-14 pb-4 border-b border-gray-100", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900", children: "Notifications" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-2 pb-8", children: MOCK_NOTIFICATIONS.map((n, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `py-3.5 ${i < MOCK_NOTIFICATIONS.length - 1 ? "border-b border-gray-50" : ""}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-800 leading-snug", children: n.text }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1", children: n.time })
                    ]
                  },
                  n.id
                )) })
...
function ChatScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm leading-tight", children: name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-600 truncate", children: company })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-5 h-5 text-blue-600" })
            }
          )
        ]
      }
      ...
      messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `max-w-[75%] rounded-2xl px-4 py-2.5 ${msg.sender === "user" ? "rounded-br-sm text-white" : "rounded-bl-sm bg-white text-gray-800 shadow-sm"}`,
              style: msg.sender === "user" ? { background: "linear-gradient(135deg, #2563EB, #7C3AED)" } : void 0,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed", children: msg.text }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: `text-[10px] mt-1 ${msg.sender === "user" ? "text-blue-200" : "text-gray-400"}`,
                    children: msg.time
                  }
                )
              ]
    ...
    isVideoCall && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/70 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl p-8 mx-6 text-center shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-12 h-12 text-blue-500 animate-pulse" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-gray-900 mb-1", children: "Video Call Starting..." }),
...
const MOCK_MESSAGES = [
  {
    ...
    avatar: "SC",
    color: "#6366f1",
    message: "Hi! I came across your profile and I'd love to chat about our Senior Designer role.",
    time: "2m ago",
    unread: 2
  },
  {
    ...
    avatar: "MJ",
    color: "#ef4444",
    message: "Your application looks great! Are you available for a quick call this week?",
    time: "1h ago",
    unread: 1
  },
  {
    ...
    avatar: "PP",
    color: "#1f2937",
    message: "Just wanted to follow up on your interview. The team loved your work!",
    time: "3h ago",
    unread: 0
  },
  {
    ...
    avatar: "TW",
    color: "#5c6bc0",
    message: "Thank you for applying. We will review and get back to you shortly.",
    time: "2d ago",
    unread: 0
  }
];
function MessagesScreen() {
  var _a2;
  const [openChat, setOpenChat] = reactExports.useState(null);
  const [callingId, setCallingId] = reactExports.useState(null);
  if (openChat) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ChatScreen,
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-14 px-5 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Messages" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mt-1", children: "Recruiter conversations" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: MOCK_MESSAGES.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                msg.unread > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 -right-1 w-5 h-5 rounded-full bg-blue-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-[10px] font-bold", children: msg.unread }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-0.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: msg.time })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-600 font-medium mb-0.5", children: msg.company }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 truncate", children: msg.message })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => {
                setCallingId(msg.id);
                setTimeout(() => setCallingId(null), 3e3);
              },
    ...
    callingId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/60 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl p-8 mx-6 text-center shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-12 h-12 text-blue-500 animate-pulse" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-gray-900 mb-1", children: "Video Call Starting..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500 mb-6", children: [
        "Connecting to",
        " ",
        (_a2 = MOCK_MESSAGES.find((m) => m.id === callingId)) == null ? void 0 : _a2.name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
const FEATURES = [
  ...
  { Icon: ChartNoAxesColumn, text: "Advanced AI market insights" },
...
function ProUpgradeSheet({ onClose }) {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-8 -top-8 w-32 h-32 rounded-full bg-white/10" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-8 h-8 text-white" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold text-xl", children: "CareerUp Pro" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm", children: "Unlock your full potential" })
                  ] })
                ] }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pt-5 pb-4", children: FEATURES.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(f.Icon, { className: "w-5 h-5 text-blue-500 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-800", children: f.text })
          ] }, f.text)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-1 rounded-2xl bg-gray-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setAnnual(false),
                className: `flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${!annual ? "bg-white shadow text-gray-900" : "text-gray-500"}`,
                children: "$9.99/month"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all relative ${annual ? "bg-white shadow text-gray-900" : "text-gray-500"}`,
                children: [
                  "$79.99/year",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-1 bg-green-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full", children: "SAVE 33%" })
                ]
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-8 pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: { background: "linear-gradient(135deg, #2563EB, #7C3AED)" },
                children: loading ? "Processing..." : "Start 7-Day Free Trial"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-gray-400 mt-3", children: "Cancel anytime. No credit card required for trial." })
          ] })
        ]
      }
    )
...
function SubScreenHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-5 pt-14 pb-4 bg-white border-b border-gray-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: title })
  ] });
}
function ToggleSwitch({ on, onToggle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        background: on ? "linear-gradient(135deg, #2563EB, #7C3AED)" : "#e5e7eb"
      },
...
function DocumentsSubScreen({ onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubScreenHeader, { title: "Documents", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 p-4 border-b border-gray-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-6 h-6 text-blue-500" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm", children: "Alex_Johnson_Resume.pdf" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Updated 3 days ago" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "w-6 h-6 text-purple-500" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm", children: "Cover_Letter_Template.docx" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Updated 1 week ago" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
function MarketInsightsSubScreen({ onBack }) {
  const stats = [
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubScreenHeader, { title: "Market Insights", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-5 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 mb-4", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-white rounded-2xl p-4 shadow-sm",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(stat.Icon, { className: `w-6 h-6 mb-1 ${stat.color}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-gray-900", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-500 leading-tight mt-0.5", children: stat.label })
          ]
        },
        stat.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 shadow-sm mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-gray-900 mb-3 text-sm", children: "Salary Range in Your Field" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-8 bg-gray-100 rounded-full overflow-hidden mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-y-0 left-0 right-0 rounded-full",
              style: {
                background: "linear-gradient(90deg, #93c5fd 0%, #2563EB 45%, #7C3AED 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-[45%] -translate-x-1/2 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-full bg-white opacity-60" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-gray-500 font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "$120K" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-blue-600", children: "$165K" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "$220K" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-gray-900 mb-3 text-sm", children: "Skills in Demand" }),
...
function NotificationsSubScreen({ onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubScreenHeader, { title: "Notifications", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm", children: NOTIF_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex items-center gap-4 px-4 py-4 ${i < NOTIF_ITEMS.length - 1 ? "border-b border-gray-50" : ""}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.Icon, { className: "w-5 h-5 text-gray-500 w-8 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-800", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: item.sub })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleSwitch,
            {
              on: toggles[item.key],
              onToggle: () => setToggles((prev) => ({
                ...prev,
...
function SettingsSubScreen({ onBack }) {
  const [profileVisible, setProfileVisible] = reactExports.useState(true);
  const [dataSharing, setDataSharing] = reactExports.useState(false);
  const sections = [
    {
      title: "Account",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubScreenHeader, { title: "Settings", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-5 py-4", children: [
      sections.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-widest mb-2 px-1", children: section.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm", children: section.items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            "data-ocid": `settings.${item.toLowerCase().replace(/ /g, "_")}.button`,
            className: `w-full flex items-center justify-between px-4 py-4 text-sm font-medium text-gray-800 active:bg-gray-50 ${i < section.items.length - 1 ? "border-b border-gray-50" : ""}`,
            children: [
              item,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-widest mb-2 px-1", children: "Privacy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-4 border-b border-gray-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-800", children: "Profile Visibility" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Show your profile to recruiters" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ToggleSwitch,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-800", children: "Data Sharing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Share anonymized data to improve matches" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ToggleSwitch,
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-widest mb-2 px-1", children: "Danger Zone" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function ProfileScreen(_props) {
  const [showPro, setShowPro] = reactExports.useState(false);
  const [subScreen, setSubScreen] = reactExports.useState(null);
  const profileStrength = 78;
  if (subScreen === "documents") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentsSubScreen, { onBack: () => setSubScreen(null) });
  }
  if (subScreen === "market-insights") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MarketInsightsSubScreen, { onBack: () => setSubScreen(null) });
  }
  if (subScreen === "notifications") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsSubScreen, { onBack: () => setSubScreen(null) });
  }
  if (subScreen === "settings") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsSubScreen, { onBack: () => setSubScreen(null) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-14 pb-6 bg-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: "w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "w-4 h-4 text-gray-600" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900 text-lg", children: "Alex Johnson" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "Senior Product Designer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-xs mt-0.5 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3" }),
            " San Francisco, CA"
          ] })
        ] })
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700", children: "Profile Strength" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold", style: { color: "#2563EB" }, children: [
                profileStrength,
                "% — Strong"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-white rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-2", children: "Add work experience to reach 90%" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: STATS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-2xl p-3 text-center shadow-sm",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.Icon, { className: "w-5 h-5 text-blue-500" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-gray-900", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 font-medium leading-tight", children: s.label })
        ]
      },
      s.label
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-5 h-5 text-white" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg", children: "Upgrade to Pro" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm", children: "Unlock Super Applies, profile views, and advanced insights" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 inline-block bg-white/20 px-3 py-1.5 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold", children: "Start Free Trial →" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-6 -top-6 w-24 h-24 rounded-full bg-white/10" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-2 top-8 w-16 h-16 rounded-full bg-white/5" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl overflow-hidden shadow-sm", children: MENU_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.Icon, { className: "w-5 h-5 text-gray-500 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-800", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: item.sub })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300", children: "›" })
        ]
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    showPro && /* @__PURE__ */ jsxRuntimeExports.jsx(ProUpgradeSheet, { onClose: () => setShowPro(false) })
  ] });
}
function SearchScreen() {
  ...
  const filtered = MOCK_JOBS.filter((job) => {
    ...
    return job.title.toLowerCase().includes(q) || job.company.toLowerCase().includes(q) || job.location.toLowerCase().includes(q) || job.skills.some((s) => s.toLowerCase().includes(q));
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-14 px-5 pb-4 bg-white border-b border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-3", children: "Search Jobs" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-5 py-4", children: [
      query.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchX, { className: "w-12 h-12 text-gray-300" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 font-medium", children: "Search for your dream job" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: 'Try "Designer", "React", or "Remote"' })
      ] }),
      query.length > 0 && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "search.empty_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Frown, { className: "w-12 h-12 text-gray-300" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 font-semibold", children: "No results found" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: "Try a different keyword" })
      ] }),
      filtered.map((job, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: job.companyInitial
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm", children: job.title }),
...
function Dashboard() {
  const [tab, setTab] = reactExports.useState("discover");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 flex flex-col bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden", children: [
      tab === "discover" && /* @__PURE__ */ jsxRuntimeExports.jsx(DiscoverScreen, {}),
      tab === "search" && /* @__PURE__ */ jsxRuntimeExports.jsx(SearchScreen, {}),
      tab === "applications" && /* @__PURE__ */ jsxRuntimeExports.jsx(ApplicationsScreen, {}),
      tab === "messages" && /* @__PURE__ */ jsxRuntimeExports.jsx(MessagesScreen, {}),
      tab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileScreen, { onUpgradePro: () => {
      } })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: { boxShadow: "0 -4px 20px rgba(0,0,0,0.05)" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                t.Icon,
                {
                  className: `w-5 h-5 transition-colors ${tab === t.id ? "text-blue-600" : "text-gray-400"}`
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
              ...
              tab === t.id && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function StepAIAnalysis({ onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-8 h-8 text-white" })
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 left-1/2 w-2 h-2 rounded-full bg-blue-300" })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-white mb-2", children: "AI is building your profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 flex items-center mb-8", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "absolute text-center text-white/80 text-sm font-medium transition-all duration-500",
            style: {
              opacity: i === currentStep ? 1 : 0,
              transform: i === currentStep ? "translateY(0)" : "translateY(10px)"
            },
            children: s
          },
          s
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-64 h-1.5 bg-white/20 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/50 text-xs mt-3", children: [
          Math.round(progress),
          "%"
        ] })
      ]
...
function StepConfirmProfile({
  data: _data,
  onComplete
}) {
  const [name, setName] = reactExports.useState("Alex Johnson");
  const [email, setEmail] = reactExports.useState("alex@example.com");
  const initials = name.split(" ").map((w) => w[0]).join("").toUpperCase().slice(0, 2);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full px-6 pb-6 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-1", children: "Your AI Profile" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Review and confirm your profile" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-2xl bg-white/60 backdrop-blur mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900", children: "87% avg match rate" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Based on your skills & preferences" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2", children: "Extracted Skills" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: EXTRACTED_SKILLS.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function Chip({ label, selected, onToggle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: onToggle,
      className: `px-4 py-2 rounded-full text-sm font-semibold border transition-all active:scale-95 ${selected ? "text-white border-transparent" : "bg-white text-gray-600 border-gray-200"}`,
      style: selected ? {
        background: "linear-gradient(135deg, #2563EB, #7C3AED)",
...
function StepPreferences({
  ...
  const [jobTypes, setJobTypes] = reactExports.useState([]);
  const [workStyle, setWorkStyle] = reactExports.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full px-6 pb-6 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-1", children: "What are you looking for?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Help us personalize your job matches" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-3", children: "Job Type" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Full-time", "Part-time", "Contract", "Internship"].map((j) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Chip,
        {
          label: j,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-3", children: "Work Style" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Remote", "Hybrid", "On-site"].map((j) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Chip,
        {
          label: j,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-3", children: "Experience Level" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Junior", "Mid-level", "Senior", "Lead"].map((j) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Chip,
        {
          label: j,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-3", children: "Location" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        type: "button",
        onClick: () => onNext({ jobTypes, workStyle, experience, location: location2 }),
        className: "w-full py-4 rounded-2xl font-semibold text-white text-base shadow-lg active:scale-95 transition-transform",
        style: { background: "linear-gradient(135deg, #2563EB, #7C3AED)" },
        children: "Continue"
      }
...
function StepResume({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full px-6 pb-6 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-1", children: "Upload Your Resume" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Our AI will extract your skills and experience" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block mb-6 cursor-pointer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `border-2 border-dashed rounded-2xl p-8 flex flex-col items-center gap-3 transition-colors ${fileName ? "border-blue-400 bg-blue-50" : "border-gray-200 bg-gray-50"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-white shadow flex items-center justify-center", children: fileName ? /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-7 h-7 text-blue-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-7 h-7 text-gray-400" }) }),
            fileName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-blue-600 text-sm", children: fileName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Tap to change" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700", children: "Upload Resume" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "PDF, DOC, DOCX up to 10MB" })
            ] })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-medium", children: "OR" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-gray-200" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-3", children: "Paste Your Experience" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
...
function VideoIntroStep({ onNext }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 bg-black flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
        autoPlay: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex justify-end pt-14 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: handleSkip,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "w-20 h-20 rounded-3xl flex items-center justify-center mb-6 shadow-2xl",
          style: { background: "linear-gradient(135deg, #2563EB, #7C3AED)" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-10 h-10 text-white" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black text-white mb-3 leading-tight", children: "CareerUp" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-white/90 mb-3", children: "Your Dream Career Awaits" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-white/60 leading-relaxed max-w-xs", children: "AI-powered matching for the modern professional" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 px-6 pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: handleSkip,
...
function OnboardingScreen({
  ...
  const steps2 = [
    /* @__PURE__ */ jsxRuntimeExports.jsx(VideoIntroStep, { onNext: () => setStep(1) }, "video"),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StepPreferences,
      {
        onNext: (d) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(StepAIAnalysis, { onDone: () => setStep(4) }, "ai"),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StepConfirmProfile, { data, onComplete }, "profile")
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 bg-white flex flex-col", children: [
    step >= 1 && step <= 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-14 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400 font-medium", children: [
        "Step ",
        progressStep + 1,
        " of ",
        totalSteps - 1
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: steps2[step] })
  ] });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-10 h-10 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-white tracking-tight", children: "CareerUp" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm mt-1 font-medium", children: "AI-Powered Career Discovery" })
            ] })
          ]
        }
      )
...
function WelcomeScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 flex flex-col", children: [
    !videoError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
        className: "absolute inset-0 w-full h-full object-cover",
        autoPlay: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0",
        style: {
          background: "linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, rgba(15,15,40,0.85) 100%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col h-full px-6 pt-16 pb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl", children: "CareerUp" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm font-semibold uppercase tracking-widest mb-3", children: "AI-Powered Matching" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl font-bold text-white leading-tight mb-4", children: [
          "Career Evolution",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Starts Here"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-base leading-relaxed", children: "Discover opportunities tailored to your skills with AI-powered job matching" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-xs text-center mt-4", children: "By continuing, you agree to our Terms & Privacy Policy" })
    ] })
  ] });
}
function App() {
  const [screen, setScreen] = reactExports.useState("splash");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        screen === "splash" && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, { onDone: () => setScreen("welcome") }),
        screen === "welcome" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          WelcomeScreen,
          {
        ...
        screen === "onboarding" && /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingScreen, { onComplete: () => setScreen("dashboard") }),
        screen === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, {})
      ]
    }
  );
}
...
const PartialJobListing = Record({
  "title": Text,
  ...
  "company": Text,
  "perks": Vec(Text),
  "salaryRange": Record({ "max": Nat, "min": Nat }),
  "location": Text
});
const Id = Nat;
...
const Profile = Record({
  ...
  "skills": Vec(Text),
  "location": Text,
  "desiredSalaryRange": Record({ "max": Nat, "min": Nat })
});
...
const UpdateJobListingInput = Record({
  "id": Id,
  "title": Text,
  "responsibilities": Vec(Text),
  "skillsRequired": Vec(Text),
...
Service({
  ...
  "addJobListing": Func([PartialJobListing], [Id], []),
  "applyToJob": Func([Id], [], []),
  ...
  "deleteJobListing": Func([Id], [], []),
  "getAllJobListings": Func([], [Vec(JobListing)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(Profile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getCallersSavedJobs": Func([Profile], [Vec(JobListing)], ["query"]),
  "getCurrentJobApplicationsProfileInput": Func(
    [Principal2, Profile],
    [Vec(JobApplication)],
    ["query"]
  ),
  "getCurrentJobListings": Func(
    [Principal2, Profile],
    [Vec(JobListing)],
    ["query"]
  ),
  "getJobListing": Func([Id], [JobListing], ["query"]),
  "getLatestJobListings": Func([], [Vec(JobListing)], ["query"]),
  "getSavedJobsProfileInput": Func(
    [Principal2, Profile],
    [Vec(JobListing)],
    ["query"]
  ),
  ...
  "unsaveJob": Func([Id], [], []),
  "updateJobListing": Func([UpdateJobListingInput], [Id], []),
  "verifyToken": Func([Text], [Principal2], [])
});
